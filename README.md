...
Recently added and experimented with Madgwick filter (imu.ccp file) , and the resuluts came up pretty smooth , there's still a yaw derivation ,will fix that after the 1st fly test
